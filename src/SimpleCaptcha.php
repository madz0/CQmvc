...
class SimpleCaptcha {
	...
	public function __construct($config = array()) {
		...
		@session_start();
		$this->conf = $this->simple_php_captcha($config);
	}
	...
	private function simple_php_captcha($config = array()) {
		// Check for GD library
		if( !function_exists('gd_info') ) {
			throw new Exception('Required GD library is missing');
		}
		$bg_path = dirname(__FILE__) . '/res/backgrounds/';
		$font_path = dirname(__FILE__) . '/res/fonts/';
		// Default values
